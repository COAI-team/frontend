 ...
 */
const WebGazerTracker = forwardRef(({ problemId, isEnabled, timeLimitMinutes = 30, onReady, onSessionStart, onSessionEnd, onNoFaceStateChange }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        ...
        // WebGazer 전용 - getTrackingData 호환성 (빈 객체 반환)
        getTrackingData: () => ({
            faceCount: 1,
            headPose: { pitch: 0, yaw: 0, roll: 0 },
            gazePosition: { x: 0, y: 0 },
            eyeState: { leftEAR: 0, rightEAR: 0, avgEAR: 0, isBlinking: false },
