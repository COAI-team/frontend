                ...
                <div className="overflow-auto" style={{maxHeight: '500px'}}>
                  {fileContent.split('\n').map((line, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-12 shrink-0 px-2 text-right text-xs select-none border-r ${theme === 'dark' ? 'bg-gray-800 border-gray-700 text-gray-600' : 'bg-gray-50 border-gray-200 text-gray-400'}`}>
                          {lineNumber}
                        </div>
