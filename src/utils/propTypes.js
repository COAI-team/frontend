...
export const CodeInlinePropTypes = {
  children: PropTypes.node.isRequired,
}

export const PostCardPropTypes = {
  post: PropTypes.shape({
    freeboardId: PropTypes.number.isRequired,
    category: PropTypes.string,
    freeboardCreatedAt: PropTypes.string,
    freeboardTitle: PropTypes.string.isRequired,
    freeboardSummary: PropTypes.string,
    userNickname: PropTypes.string,
    freeboardClick: PropTypes.number,
...
export const PopularPostsListPropTypes = {
  popularPosts: PropTypes.arrayOf(
    PropTypes.shape({
      freeboardId: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
        .isRequired,
    })
  ),
